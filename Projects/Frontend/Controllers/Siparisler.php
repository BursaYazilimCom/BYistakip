...
use AyarModel,UyeModel,CariModel,SiparisModel, InternalUrunModel as UrunModel,KasaModel,FaturaModel,InternalTedarikciModel as TedarikciModel;
...
class Siparisler extends Controller
{
    ...
    public function main($sayfa=null){
        ...
        $siparisUrunleri     = SiparisModel::uyeSiparisUrunleri($user->id,$sayfa);
