                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                            ...
                            @foreach($calismalar['liste'] as $yol)
                                ...
                                <h6 class="border-bottom pb-2 mb-0">{{Date::convert($yol->tarih,"d.m.Y")}}</h6>


                                {[ } ]}

                                    <div class="my-3 p-4 bg-body rounded shadow-sm">
                                        <h6 class="border-bottom pb-2 mb-0">Projede  Yapılan Çalışmalar ve Devam Eden Çalışmalar</h6>

                                        <div class="d-flex text-body-secondary p-2">
                                            <svg class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="20" height="20" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 32x32" preserveAspectRatio="xMidYMid slice" focusable="false">
                                                @if($yol->tur=="1")
                                                <rect width="100%" height="100%" fill="#413EE8"></rect>
                                                @elseif($yol->tur=="2")
                                                <rect width="100%" height="100%" fill="#FF6600"></rect>
                                                @elseif($yol->tur=="3")
                                                <rect width="100%" height="100%" fill="#2FB62F"></rect>
                                                @endif
                                            </svg>
                                            <p class="p-1 mb-0 lh-sm border-bottom">
