                                ...
                                <div class="table-responsive border-bottom mb-9">
                                    <table class="table mb-3">
                                        ...
                                        <tr class="fw-bolder text-gray-700 fs-5">
                                            ...
                                            <td class="pt-6 text-end">{{number_format((float)$furun->fiyat,2)}}</td>
                                            <td class="pt-6 text-end">%{{$furun->kdv}}</td>
                                            <td class="pt-6 text-end text-dark fw-boldest">{{number_format((float)$furun->fiyat*$furun->miktar,2)}} ₺</td>
                                        </tr>
                                        @endforeach
                                ...
                                <div class="d-flex justify-content-end">
                                    ...
                                    <div class="mw-300px">
                                        ...
                                        <div class="d-flex flex-stack mb-3">
                                            ...
                                            <!--end::Accountnumber-->
                                            <!--begin::Number-->
                                            <div class="text-end fw-bolder fs-6 text-gray-800">{{number_format((float)$kdv20+$kdv10,2)}} ₺</div>
                                            <!--end::Number-->
                                        </div>
                                        <!--end::Item-->
                                        <!--begin::Item-->
