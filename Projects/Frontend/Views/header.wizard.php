<div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    ...
    <div class="container-xxl d-flex align-items-center">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="{{URl::site()}}">
                <img alt="Logo" src="{{URl::site()}}Uploads/site-img/{{AyarModel::defaultAyarlar('firmaLogo')}}" class="h-15px h-lg-40px logo-default" />
                <img alt="Logo" src="{{URl::site()}}Uploads/site-img/{{AyarModel::defaultAyarlar('firmaLogo')}}" class="h-15px h-lg-40px logo-sticky" />
            </a>
        </div>
        <!--end::Header Logo-->
        <!--begin::Wrapper-->
