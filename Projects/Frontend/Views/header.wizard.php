<div id="kt_header" class="header align-items-stretch" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
    ...
    <div class="container-xxl d-flex align-items-center">
        ...
        <div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
            <a href="{{URl::site()}}">
                <img alt="Logo" src="{{URl::site()}}Uploads/site-img/{{AyarModel::defaultAyarlar('firmaLogo')}}" class="h-15px h-lg-30px logo-default" />
                <img alt="Logo" src="{{URl::site()}}Uploads/site-img/{{AyarModel::defaultAyarlar('firmaLogo')}}" class="h-15px h-lg-30px logo-sticky" />
            </a>
        </div>
        <!--end::Header Logo-->
        <!--begin::Wrapper-->
        <div class="d-flex d-print-none align-items-stretch justify-content-between flex-lg-grow-1">
            <!--begin::Navbar-->
                    ...
                    <div class="topbar d-flex align-items-stretch flex-shrink-0">
                        <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="Logo" src="media/avatars/no-avatar.jpg" />
                                        </div>
                                        <div class="d-flex flex-column">
                                            <div class="fw-bolder d-flex align-items-center fs-5">{{$user->adi}}</div>
                                            <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{$user->firma_adi}}</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="separator my-2"></div>
                                <div class="menu-item px-5">
                                    <a href="{{URL::site('login/out')}}" class="menu-link px-5">Çıkış Yap</a>
                                </div>
                            </div>
                        </div>
                    </div>
