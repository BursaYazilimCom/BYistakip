                    ...
                    <div class="col-xxl-12">
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-header align-items-center border-0 mt-5">
                                ...
                                <div class="card-toolbar"><a class="badge badge-primary" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Tüm Faturalarımı Göster" href="{{URL::site('destek/form')}}"><strong>Yeni Destek Talebi Oluştur Projeleriniz</strong></a>
                                </div>
                            </div>  
                            <!--end::Header-->
                            <!--begin::Body-->
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($listele['liste'] as $tlp)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{URL::site('destek/detay/'.$tlp->id)}}" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-placement="top" title="Talep Görüntüle" target="_blank" ><i class="bi bi-eye-fill fs-4 me-2 text-primary"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
