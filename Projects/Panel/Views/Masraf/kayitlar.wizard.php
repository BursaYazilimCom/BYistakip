                                    ...
                                    <td>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#"><strong class="text-primary text-bold"><i class="fa fa-edit"></i> Düzenle</strong></a></li>
                                                <li><a href="#"><strong class="text-success text-bold"><i class="fa fa-plus"></i> Belge Ekle</strong></a></li>
                                                <li><a href="#"><strong class="text-danger text-bold"><i class="fa fa-times"></i> Sil</strong></a></li>
                                            </ul>
                                        </div>
                                    </td>
