        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Ürün Yönetimi</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{URL::site()}}">Anasayfa</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Ürünler</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="dt-action-buttons text-end">
                                    <a href="{{URL::site('urun/form')}}" class="dt-button create-new btn btn-primary" tabindex="0" ><span><i data-feather="plus"></i>EKLE</span></a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover  table-bordered">
                                        ...
                                        <tr id="row-{{$u->id}}">
                                            ...
                                            <td>
                                                ...
                                                <span class="badge bg-warning">Tek Seferlik</span>
                                                @else
                                                <span class="badge bg-danger">Yenilenen</span>
                                                @endif
                                                </td>
                                            <td>
                                                @if($u->odeme_turu=="U")
                                            ...
                                            <td>
                                                ...
                                                @if($u->stoklu_urun=="1")
                                                    {{$u->guncel_stok}}
                                                @else
                                                <span class="badge bg-danger">Stoksuz</span>
                                                @endif
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{URL::site('urun/form')}}/{{$u->id}}" class="dropdown-item">
                                                            <i data-feather="edit-2" class="me-50"></i>
                                                            <span>Düzenle</span>
                                                        </a>
                                                        <a class="dropdown-item" onclick="deleteAction('{{$u->id}}','{{URL::site('urun/ajax')}}','urunSil')">
