            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item dropdown dropdown-language">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                        ...
                        <a class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$pb->para}}">{{$pb->sembol}} {{number_format((float)$pb->guncel_kur,2,',','.')}} TL</a>
                        @endforeach
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{$user->isim}}</span><span class="user-status">Yönetim</span></div><span class="avatar"><img class="round" src="{{URL::site()}}../Uploads/personel_resimleri/{{$user->resim}}" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal navbar-light navbar-shadow menu-border fixed-top" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="#" data-bs-toggle="dropdown"><i data-feather="aperture"></i><span>Ads</span></a>
                        <ul class="dropdown-menu" data-bs-popper="none">
                            <li data-menu="">
