            ...
            <section id="basic-horizontal-layouts">
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        @Form::csrf()->action("teklifler/guncelle/".$detay->id)->open('submitForm',['class'=>'form form-horizontal'])
                                ...
                                <div class="card brdt-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-12">
                                                    <label class="col-form-label" for="cari">Teklif Tarihi</label>
                                                </div>
                                                <div class="col-sm-12">
                                                    <input type="datetime-local" name="belge_tarihi" class="form-control form-control-sm" id="belge_tarihi" value="{{$detay->ekleme_tarihi}}" placeholder="Teklif Tarihi" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <hr>
                                        <div class="table-responsive">
                                            <table class="table table-hover table-responsive">
                                                ...
                                                @foreach($teklifUrunleri as $turun)

                                                    {[
                                                        $araToplamTutar = $araToplamTutar+($turun->fiyat*$turun->miktar);
                                                        $toplamTutar    = $toplamTutar+$turun->tutar;
                                                    ]}

                                                    @if($turun->kdv=="10")
                                                    {[
                                                        $kdv10 = $kdv10+$turun->kdv_tutari;
                                                    ]}
                                                    @endif

                                                    @if($turun->kdv=="20")
                                                    {[
                                                        $kdv20 = $kdv20+$turun->kdv_tutari;
                                                    ]}
                                                    @endif

                                                <tr id="row-{{$turun->id}}">
                                                    <td style="min-width: 300px">
                                                        <input type="hidden" name="id[]" id="id" value="{{$turun->id}}">
                                                        <input type="text" name="urun_adi[]" id="urun_adi" value="{{$turun->urun_adi}}" class="form-control">
                                                    ...
                                                    <td>
                                                        ...
                                                        {{$turun->miktar}}
                                                        @else
                                                        <input type="number" name="miktar[]" id="miktar" value="{{$turun->miktar}}" class="miktar form-control">
                                                        @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="kdv[]" id="kdv" class="kdv form-control">
                                                            <option value="">--Seçiniz--</option>
                                                            <option value="0" {{$turun->kdv == "0" ? 'selected' : ''}}>%0</option>
                                                            <option value="10" {{$turun->kdv == "10" ? 'selected' : ''}}>%10</option>
                                                            <option value="20" {{$turun->kdv == "20" ? 'selected' : ''}}>%20</option>
                                                        </select>
                                                        @endif
                                                    ...
                                                    <td>
                                                        <a class="text-danger" data-bs-toggle="tooltip" data-bs-title="Teklif Kalemini Sil" onclick="deleteAction('{{$turun->id}}','{{URL::site('teklifler/ajax')}}','teklifUrunSil')">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <a data-bs-toggle="modal" data-bs-target="#openModal" data-id="{{$detay->id}}" data-action="teklifeUrunEkle" class="dt-button create-new btn btn-success">
