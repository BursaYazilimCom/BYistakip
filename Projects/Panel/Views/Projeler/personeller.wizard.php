                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#">Proje Çalışanları</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card brdt-info">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">Proje Çalışanları</h4>
                                </div>
                                <div class="dt-action-buttons text-end">

                                    <a data-bs-toggle="modal" data-bs-target="#openModal" data-id="{{$detay->id}}" data-action="projePersonelEkle" class="dt-button create-new btn btn-primary dropdown-item text-warning">
                                        ...
                                        <div class="card-datatable table-responsive-sm table-responsive-md table-responsive-xl">
                                            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                                                ...
                                                <table class="invoice-list-table table dataTable no-footer dtr-column"
                                                    ...
                                                    <tr id="row-{{$p->id}}">
                                                        <td>#{{$p->id}}</td>
                                                        <td>{{PersonelModel::isim($p->personel_id)}}</td>
                                                        <td>{{$p->gorevi}}</td>
                                                        <td>{{Date::convert($p->tarih,"d.m.y H:i")}}</td>
                                                    
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <span data-bs-toggle="tooltip" title="Düzenle">
                                                                    <a class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#openModal" data-id="{{$p->id}}" data-action="projePersonelDuzenle" class="dropdown-item">
                                                                    <i data-feather="edit-2" class="me-50"></i>
                                                                </a>
                                                                </span>
                                                                <a class="btn btn-danger btn-sm" data-bs-toggle="tooltip" title="Sil" onclick="deleteAction('{{$p->id}}','{{URL::site('Projeler/ajax')}}','personelSil')"><i data-feather="trash" class="me-50"></i></a>
                                                            </div>
